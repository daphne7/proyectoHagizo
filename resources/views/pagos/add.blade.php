...
<div class="row justify-content-center">
    <div class="col-md-10 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
            <h2 class="card-title text-center">REGISTRAR NUEVO PAGO <hr></h2>  <!-- route('pagoSave') -->
            <form id="miForm" class="forms-sample" method="post" action="{{ route('pago.store') }}" enctype="multipart/form-data">
                @csrf                                                  
                <div class="row mb-3">
                    <div class="col-md-6">
